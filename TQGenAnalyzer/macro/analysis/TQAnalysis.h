...
// Wed May  5 10:22:42 2021 by ROOT version 6.14/09
...
#ifdef TQAnalysis_cxx
TQAnalysis::TQAnalysis(TTree *tree) : fChain(0) 
{
...
TQAnalysis::~TQAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TQAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TQAnalysis::LoadTree(Long64_t entry)
{
...
void TQAnalysis::Init(TTree *tree)
{
...
void TQAnalysis::Show(Long64_t entry)
{
...
Int_t TQAnalysis::Cut(Long64_t entry)
{
