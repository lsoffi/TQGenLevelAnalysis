...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *recoDimu_index1;
   vector<int>     *recoDimu_index2;
   ...
   vector<int>     *recoDiele_index1;
   vector<int>     *recoDiele_index2;
   ...
   TBranch        *b_recoDimu_index1;   //!
   TBranch        *b_recoDimu_index2;   //!
   ...
   TBranch        *b_recoDiele_index1;   //!
   TBranch        *b_recoDiele_index2;   //!
...
#ifdef AnalysisTQ_cxx
AnalysisTQ::AnalysisTQ(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_egamma/soffi/ggXToYYTo2mu2e/ntuple_ggXToYYTo2mu2e_m26_PseudoScalar_13TeV_106X_PRIVATE_MATTIA_100K.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_egamma/soffi/ggXToYYTo2mu2e/ntuple_ggXToYYTo2mu2e_m26_PseudoScalar_13TeV_106X_PRIVATE_MATTIA_100K.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_egamma/soffi/ggXToYYTo2mu2e/ntuple_ggXToYYTo2mu2e_m26_PseudoScalar_13TeV_106X_PRIVATE_MATTIA_100K.root:/GenAnalysis");
...
AnalysisTQ::~AnalysisTQ()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t AnalysisTQ::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnalysisTQ::LoadTree(Long64_t entry)
{
...
void AnalysisTQ::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("recoDimu_index1", &recoDimu_index1, &b_recoDimu_index1);
   fChain->SetBranchAddress("recoDimu_index2", &recoDimu_index2, &b_recoDimu_index2);
   ...
   fChain->SetBranchAddress("recoDiele_index1", &recoDiele_index1, &b_recoDiele_index1);
   fChain->SetBranchAddress("recoDiele_index2", &recoDiele_index2, &b_recoDiele_index2);
...
void AnalysisTQ::Show(Long64_t entry)
{
...
Int_t AnalysisTQ::Cut(Long64_t entry)
{
