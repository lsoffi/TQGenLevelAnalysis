...
process.defaultLowPtGsfElectronID = cms.EDProducer("LowPtGsfElectronIDProducer",
...
process.GenAnalysis = cms.EDAnalyzer("TQGenAnalyzer",
    ...
    patElectronsLowPt = cms.InputTag("slimmedLowPtElectrons"),
    ...
    sampleXsec = cms.untracked.double(1.0),
