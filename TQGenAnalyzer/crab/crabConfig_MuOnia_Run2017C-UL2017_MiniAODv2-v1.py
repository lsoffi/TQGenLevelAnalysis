...
config.General.requestName = 'MuOnia_Run2017C-UL2017_MiniAODv2-v1'
...
config.Data.userInputFiles = open('MuOnia_Run2017C-UL2017_MiniAODv2-v1.txt').readlines()
...
## Output Data ##
config.Data.outputPrimaryDataset = 'MuOnia_Run2017C-UL2017_MiniAODv2-v1'
