...
config.General.requestName = 'ggXToYYTo2mu2e_m18_PseudoScalar_13TeV_106X_PRIVATE_MATTIA_100K'
...
config.Data.userInputFiles = open('ggXToYYTo2mu2e_m18_PseudoScalar_13TeV_106X_PRIVATE_MATTIA_100K.txt').readlines()
...
## Output Data ##
config.Data.outputPrimaryDataset = 'ggXToYYTo2mu2e_m18_PseudoScalar_13TeV_106X_PRIVATE_MATTIA_100K'
